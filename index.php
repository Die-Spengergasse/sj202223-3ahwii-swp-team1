...
if (isset($_GET['logout'])) {
    $fp = fopen("log.html", 'a');// Schreibt in den Chatverlauf (Logdatei log.html), dass der Benutzer den Chat verlassen hat, wenn Logout gedrückt wird
...
/**
 * Die Funktion loginForm Gibt eine Schöne Seite aus, wo man sich einen Benutzernamen für den Chat aussuchen kann
 */
function loginForm()
{
    echo '
...
if (isset($_POST['enter'])) {
    ...
    if ($_POST['name'] != "") // Wenn das Namensfeld nicht Leer ist wird hier eine Chat Session mit dem Gewählten Benutzernamen angelegt
    {
